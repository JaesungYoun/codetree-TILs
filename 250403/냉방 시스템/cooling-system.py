...
def cooling(x,y,d):
    ...
    if d == 0: # 에어컨 방향이 왼쪽
        ...
        while queue:
            ...
            if in_range(x-1,y-1) and wall[x-1][y][1] == 0 and wall[x-1][y-1][3] == 0:
                temp[x-1][y-1] = cool - 1
                if cool - 1 > 1:
                    queue.append((x-1,y-1,cool-1))
            if in_range(x+1,y-1) and wall[x+1][y][0] == 0 and wall[x+1][y-1][3] == 0:
                temp[x+1][y-1] = cool - 1
                if cool - 1 > 1:
                    queue.append((x+1,y-1,cool-1))
        ...
        while queue:
            ...
            if in_range(x-1,y-1) and wall[x][y-1][3] == 0 and wall[x-1][y-1][1] == 0:
                temp[x-1][y-1] = cool -1
                if cool - 1 > 1:
                    queue.append((x-1,y-1,cool-1))
            if in_range(x-1,y+1) and wall[x][y+1][2] == 0 and wall[x-1][y+1][1] == 0:
                temp[x-1][y+1] = cool -1
                if cool - 1 > 1:
                    queue.append((x-1,y+1,cool-1))
        for i in range(N):
        ...
        while queue:
            ...
            if in_range(x,y+1) and wall[x][y+1][2] == 0:
                ...
                if cool - 1 > 1:
                    queue.append((x,y+1,cool-1))
            if in_range(x-1,y+1) and wall[x-1][y][1] == 0 and wall[x-1][y+1][2] == 0:
                temp[x-1][y+1] = cool - 1
                if cool - 1 > 1:
                    queue.append((x-1,y+1,cool-1))
            if in_range(x+1,y+1) and wall[x+1][y][0] == 0 and wall[x+1][y+1][2] == 0:
                temp[x+1][y+1] = cool -1
                if cool - 1 > 1:
                    queue.append((x+1,y+1,cool-1))
        for i in range(N):
        ...
        while queue:
            ...
            if in_range(x+1,y) and wall[x+1][y][0] == 0:
                ...
                if cool - 1 > 1:
                    queue.append((x+1,y,cool-1))
            if in_range(x+1,y-1) and wall[x][y-1][3] == 0 and wall[x+1][y-1][0] == 0:
                temp[x+1][y-1] = cool - 1
                if cool - 1 > 1:
                    queue.append((x+1,y-1,cool-1))
            if in_range(x+1,y+1) and wall[x][y+1][2] == 0 and wall[x+1][y+1][0] == 0:
                temp[x+1][y+1] = cool - 1
                if cool - 1 > 1:
                    queue.append((x+1,y+1,cool-1))
